...
<html lang="pt">
    <head>
        <title>Agendamento online | Salão André Puchetti</title>
        <link rel="icon" type="image/png" href="assets/logo-salao.png">
        <link rel="apple-touch-icon" href="assets/logo-salao.png">
        <meta charset="utf-8">
        <meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
        <meta content="Agende online seu horário no Salão André Puchetti com praticidade e escolha profissional, serviço, data e horário." name="description">
